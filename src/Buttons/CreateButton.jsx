...
import '/src/CreateButton.css'; // Assuming you have a corresponding CSS file

const SparkleButton = ({value,onClick}) => {
  return (
    <div className="sp">
      ...
      <span aria-hidden="true" className="particle-pen">
        {[...Array(10)].map((_, index) => (
          <svg key={index} className="particle" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
