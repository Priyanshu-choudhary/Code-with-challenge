...
//  console.log("image "+courseDetail.imageUrl);
  
  const [languages, setLanguages] = useState({
    java: courseDetail.language[0]=="java" ?true:false,
    python: courseDetail.language[1]=="python" ?true:false,
    c: courseDetail.language[2]=="c" ?true:false,
    cpp: courseDetail.language[3]=="cpp" ?true:false,
  });
// console.log("course detail"+JSON.stringify(courseDetail));
