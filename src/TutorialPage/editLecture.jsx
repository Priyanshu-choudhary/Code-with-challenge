...
export default function EditLecture() {
  ...
  useEffect(() => {
    const fetchLectureData = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/Lecture/id/${id}`, {
  ...
  const handleDelete = async (headingTitle, subHeadingTitle) => {
    ...
    try {
      ...
      // console.log(`${import.meta.env.VITE_API_URL}/Lecture/removeHeadings/id/${id}`+"  >> "+JSON.stringify(data));

      await axios.put(
        `${import.meta.env.VITE_API_URL}/Lecture/removeHeadings/id/${id}`,
        data,
        {
          headers: { 'Content-Type': 'application/json' },
          auth: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_API_URL}/Lecture/id/${id}`,
        formData,
        {
          headers: { 'Content-Type': 'application/json' },
          auth: {
