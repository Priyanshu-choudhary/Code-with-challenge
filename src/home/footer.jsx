      ...
      <div className="relative isolate overflow-hidden  py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            We collaborate with a diverse community of students, educators, and organizations to create impactful hackathons. Whether you're a tech enthusiast, a mentor, or an organization looking to foster innovation, join us in making a difference together!
            </p>
          </div>
